...
╚═╝     ╚═╝╚══════╝╚═╝                    
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mFuhadTricker7x
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801*********
\x1b[93;1m FB Page      \x1b[92;1m=>      \x1b[93;1mDAED LINE
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/profile.php?id=100085230327998")
		exit()
	else:
		os.system("https://www.facebook.com/profile.php?id=100085230327998")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [M2F] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
if __name__=='__main__':
	...
	os.system("xdg-open https://www.facebook.com/profile.php?id=100085230327998l")
	menu()
